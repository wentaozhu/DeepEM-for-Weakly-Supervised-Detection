''' Wentao Zhu, wentaozhu1991@gmail.com
    Put the file into the NLST folder, and run. It will delete
    the CT images that do not appear in the csv file  
    file organization: .../NLST/filterctim.py; .../NLST/NLST/****/****; 
    .../NLST/package-nlst-304-2017.07.05/Spiral CT Abnormalities CSV/sctabn.csv '''
import csv 
import os 
import shutil
...
qcsvpath = './package-nlst-304-2017.07.05/queryResultfinal.csv' # query csv
savetxt = './package-nlst-304-2017.07.05/savepidfinal.txt'
f = open(csvpath)
csvf = csv.reader(f)
count = 0
